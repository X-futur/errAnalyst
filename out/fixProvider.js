...
class FixProvider {
    ...
    async applyFixToFile(uri, targetLine, insertAsNew) {
        try {
            ...
            const choice = await vscode.window.showInformationMessage('ErrAnalyst: \u5e94\u7528\u4fee\u590d?', { modal: false, detail: detailStr }, '\u5e94\u7528', '\u53d6\u6d88');
            if (choice !== '\u5e94\u7528')
                return;
            ...
            const action = await vscode.window.showInformationMessage('ErrAnalyst: ' + relPath + ' \u7eff\u8272\u9ad8\u4eae\u884c\u5df2\u4fee\u6539', '\u2713 \u4fdd\u7559', '\u21a9 \u64a4\u9500');
            if (action === '\u21a9 \u64a4\u9500') {
